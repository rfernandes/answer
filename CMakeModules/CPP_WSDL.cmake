...
add_custom_command(
	...
	COMMAND xsltproc --stringparam project_name ${PROJECT_NAME} --path "${CMAKE_BINARY_DIR}/xml" ${CMAKE_CURRENT_SOURCE_DIR}/../tools/doxygen_cpp_wsdl/wsdl.xslt namespace_web_services.xml > ${CMAKE_BINARY_DIR}/${PROJECT_NAME}.wsdl
	COMMAND xsltproc --stringparam project_name ${PROJECT_NAME} --path "${CMAKE_BINARY_DIR}/xml" ${CMAKE_CURRENT_SOURCE_DIR}/../tools/doxygen_cpp_wsdl/serviceDescriptor.xslt namespace_web_services.xml > ${CMAKE_BINARY_DIR}/serviceDescription.xml
	COMMAND xsltproc --stringparam project_name ${PROJECT_NAME} --path "${CMAKE_BINARY_DIR}/xml" ${CMAKE_CURRENT_SOURCE_DIR}/../tools/doxygen_cpp_wsdl/services_js.xslt namespace_web_services.xml > ${CMAKE_BINARY_DIR}/services.js
	# Not yet implemented
	#COMMAND xsltproc --path "${CMAKE_CURRENT_SOURCE_DIR}/xml" ${CMAKE_CURRENT_SOURCE_DIR}/../tools/doxygen_cpp_wsdl/wsdl.xslt ${CMAKE_CURRENT_SOURCE_DIR}/xml/namespace_web_services.xml > ${CMAKE_BINARY_DIR}/${PROJECT_NAME}.js
)

set(CPP_WSDL_OUTPUT
	${CMAKE_BINARY_DIR}/services.xml
	${CMAKE_BINARY_DIR}/${PROJECT_NAME}.js
	${CMAKE_BINARY_DIR}/${PROJECT_NAME}.wsdl
